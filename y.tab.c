...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_OP_OR = 11,                     /* OP_OR  */
  YYSYMBOL_OP_GREATER = 12,                /* OP_GREATER  */
  YYSYMBOL_OP_GREATER_OR_EQ = 13,          /* OP_GREATER_OR_EQ  */
  YYSYMBOL_OP_LESS = 14,                   /* OP_LESS  */
  YYSYMBOL_OP_LESS_OR_EQ = 15,             /* OP_LESS_OR_EQ  */
  YYSYMBOL_OP_EQ = 16,                     /* OP_EQ  */
  YYSYMBOL_OP_NEQ = 17,                    /* OP_NEQ  */
  YYSYMBOL_ELEMENT = 18,                   /* ELEMENT  */
  YYSYMBOL_NEW = 19,                       /* NEW  */
  YYSYMBOL_HTML = 20,                      /* HTML  */
  YYSYMBOL_NAVBAR = 21,                    /* NAVBAR  */
  YYSYMBOL_FOOTER = 22,                    /* FOOTER  */
  YYSYMBOL_CONTAINER = 23,                 /* CONTAINER  */
  ...
  YYSYMBOL_assignation = 53,               /* assignation  */
  YYSYMBOL_tag = 54                        /* tag  */
};
...
static const char *const yytname[] =
{
  ...
  "FOR", "DO", "WHILE", "RETURN", "OP_AND", "OP_OR", "OP_GREATER",
  "OP_GREATER_OR_EQ", "OP_LESS", "OP_LESS_OR_EQ", "OP_EQ", "OP_NEQ",
  "ELEMENT", "NEW", "HTML", "NAVBAR", "FOOTER", "CONTAINER", "HEADER",
  "MAIN", "ID", "'='", "OR", "AND", "'>'", "'<'", "LE", "GE", "EQ", "NE",
  "'+'", "'-'", "'*'", "'/'", "UMINUS", "'!'", "'('", "')'", "'{'", "'}'",
  "';'", "$accept", "main", "body", "statement", "definition",
  "declaration", "assignation", "tag", YY_NULLPTR
};
...
{
     -23,   -39,     4,   -38,   -40,   -37,   -17,   -20,   -12,   -18,
     -28,   -40,   -11,   -40,   -40,   -10,   -40,   -40,   -40,   -10,
...
{
     -40,   -40,   -40,     8,   -40,   -40,   -40,     0
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     2,     9,    10,    11,    12,    13,    25
};
...
{
       7,     7,     1,     3,     4,     5,    14,     6,     8,     8,
      20,    21,    22,    23,    24,    15,    19,    17,    18,    26,
       0,     0,     0,     0,     0,     0,     0,    16
};

static const yytype_int8 yycheck[] =
{
      18,    18,    25,    42,     0,    43,    26,    44,    26,    26,
      20,    21,    22,    23,    24,    27,    27,     9,    46,    19,
      -1,    -1,    -1,    -1,    -1,    -1,    -1,    45
};
...
{
       0,    25,    48,    42,     0,    43,    44,    18,    26,    49,
      50,    51,    52,    53,    26,    27,    45,    50,    46,    27,
      20,    21,    22,    23,    24,    54,    54
};
